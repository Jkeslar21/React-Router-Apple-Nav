...
export default function Nav() {
  return (
    <div className='nav'>
      ...
      <Link to='/'><img src='https://www.apple.com/ac/globalnav/4/en_US/images/globalnav/links/mac/image_large.svg' className='nav-link' /></Link>
      <Link to='/'><img src='https://www.apple.com/ac/globalnav/4/en_US/images/globalnav/links/ipad/image_large.svg' className='nav-link' /></Link>
